...
export function creerAutomobiliste(http: HttpClient, rootUrl: string, params: CreerAutomobiliste$Params, context?: HttpContext): Observable<StrictHttpResponse<AutomobilisteDto>> {
...
creerAutomobiliste.PATH = '/Automobiliste/Creer';
