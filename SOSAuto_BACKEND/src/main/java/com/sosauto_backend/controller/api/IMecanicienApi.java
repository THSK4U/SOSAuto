...
public interface IMecanicienApi {
    ...
    AuthResponse creerMecanicien(@RequestBody MecanicienDTO mécanicien);
    ...
    MecanicienDTO mettreAjourMecanicien(@PathVariable("id") Long id, @RequestBody MecanicienDTO mécanicien);
    ...
    MecanicienDTO mettreAjourDisponibilite(@PathVariable("id") Long id, @RequestBody MecanicienDTO mécanicien);
