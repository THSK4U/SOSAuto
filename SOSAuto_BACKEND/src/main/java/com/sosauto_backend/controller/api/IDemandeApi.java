...
public interface IDemandeApi {
    ...
    //supprimer
    @DeleteMapping(value = "/DemandeDepannage/Delete/{id}", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    void supprimerDemande(@PathVariable("id") Long id);

    //Tous
    @GetMapping(value = "/DemandeDepannage", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
